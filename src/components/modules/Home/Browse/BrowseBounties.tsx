...
const MOCK_BOUNTIES: Bounty[] = [
  {
    ...
    deadline: "2025-05-10",
    description:
      "JWT token refresh is failing silently on mobile clients. Need a clean fix with tests.",
    postedAt: "2025-04-01",
    postedBy: "Alex R.",
  },
  {
    ...
    deadline: "2025-05-15",
    description:
      "Modern, conversion-focused landing page. Figma source file required.",
    postedAt: "2025-04-03",
    postedBy: "Sara M.",
  },
  {
    ...
    deadline: "2025-05-20",
    description:
      "Each post should be 1200+ words targeting specific long-tail keywords.",
    postedAt: "2025-03-15",
    postedBy: "James K.",
  },
  {
    ...
    deadline: "2025-05-30",
    description:
      "Full scope pentest, OWASP top 10 minimum. Report with severity ratings.",
    postedAt: "2025-04-10",
    postedBy: "Nina T.",
  },
  {
    ...
    deadline: "2025-05-28",
    description:
      "~800 strings. Context-aware translation, not just literal. Native speakers only.",
    postedAt: "2025-03-10",
    postedBy: "Leo B.",
  },
  {
    ...
    deadline: "2025-05-12",
    description:
      "Extract the best 60–90 second clips from each video. Export as MP4.",
    postedAt: "2025-04-08",
    postedBy: "Dana W.",
  },
];
      ...
      <CardContent className="px-5 pb-5">
        ...
        <div className="flex items-center justify-between flex-wrap gap-2">
          ...
          <Button size="sm" className="h-8 text-xs gap-1.5" asChild>
            <Link href={`/browse/${bounty.id}`}>View Bounty</Link>
          </Button>
        </div>
      </CardContent>
    </Card>
